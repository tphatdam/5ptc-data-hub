...
@Injectable()
export class VnStockProvider implements IStockProxyProvider {
  readonly code = 'VNSTOCK';
  ...
  constructor(
    ...
    this.baseUrl =
      this.configService.get<string>('vnStock.apiUrl') ||
      process.env.VN_STOCK_API_URL ||
      '';
  }
