...
@Injectable()
export class RunDailyCompanyUseCase {
  private readonly logger = new Logger(RunDailyCompanyUseCase.name);
  ...
  async execute(): Promise<void> {
    this.logger.log('Executing daily-company ingestion use case');
    await this.marketIngestionPort.runDailyCompany();
  }
}
